...
git_repo="git@github.com:skulumani/2016_ACC_experiment.git"
bb_repo="git@bitbucket.org:shankarkulumani/2016-acc-experiment.git"
fdcl_repo="git@github.com:fdcl-gwu/2016_ACC_experiment.git"
